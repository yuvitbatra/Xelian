...
class XelianError(Exception):
    pass


class InstallError(XelianError):
    pass


class TypeMismatchError(XelianError):
    pass
...
def _load_manifest(package_dir: Path) -> dict:
    manifest_path = package_dir / "xelian.toml"
    if not manifest_path.exists():
        raise InstallError(f"xelian.toml not found at {manifest_path}")
