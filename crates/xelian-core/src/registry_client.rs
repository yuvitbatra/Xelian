//! HTTP client for the Xelian registry API (SPEC.md §14.8).
//!
...
/// A typed HTTP client for the Xelian registry API.
...
impl RegistryClient {
    ...
    ///
    /// Uploads the `.xelian` archive and its `xelian.lock` to
    ...
    pub fn publish(
        ...
        write_field(
            ...
            &boundary,
            "archive",
            Some(("archive.xelian", "application/octet-stream")),
            &archive_bytes,
        );
        ...
        write_field(
            ...
            &boundary,
            "lockfile",
            Some(("xelian.lock", "application/toml")),
            &lockfile_bytes,
        );
...
mod tests {
    ...
    /// Build a minimal valid .xelian archive in memory for testing.
    #[allow(dead_code)]
...
"#
    ...
    fn build_multipart_body_is_well_formed() {
        ...
        write_field(
            ...
            boundary,
            "archive",
            Some(("pkg.xelian", "application/octet-stream")),
